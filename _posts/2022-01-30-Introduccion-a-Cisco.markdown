...
En otro post explicaré el procedimiento a seguir para agregar las imágenes de los dispositivos con los que trabajaremos para que no se haga tan larga esta instroduccíón. El procedimiento para configurar un direccionamiento estático a la máquina virtual lo explico a continuación:
